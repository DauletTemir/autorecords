...
export default function GoogleAuthButton() {
  ...
  return (
    <button
      type="button"
      onClick={handleClick}
      className="font-body flex items-center justify-center gap-2 w-full"
      style={{
        border: `1.5px solid ${C.line}`, borderRadius: 999, padding: "9px 16px",
        fontSize: 14, background: "#fff", color: C.headingText, cursor: "pointer",
      }}
    >
